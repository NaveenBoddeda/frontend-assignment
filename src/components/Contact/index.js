...
import facebookBasics from './facebook basics.mp4'
import './index.css'
    ...
    return (
      <div className="container">
        <video width="50%" height="200%" controls>
          <source src={facebookBasics} type="video/mp4" />
          <track kind="captions" src={`${facebookBasics}.vtt`} />
        </video>
        {inFormPage ? (
          this.renderForm()
        ) : (
